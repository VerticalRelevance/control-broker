...
class ControlBrokerStack(Stack, SecretConfigStackMixin):
    ...
    def pac_frameworks(self):
        ...
        aws_s3_deployment.BucketDeployment(
            ...
            sources=[
                aws_s3_deployment.Source.asset("./supplementary_files/evaluation_context")
            ],
        ...
        aws_s3_deployment.BucketDeployment(
            ...
            sources=[
                aws_s3_deployment.Source.asset("./supplementary_files/pac_frameworks")
            ],
    ...
    def output_handler_event_driven(self):
        ...
        self.lambda_output_handler_opa = aws_lambda.Function(
            ...
            code=aws_lambda.Code.from_asset(
                "./supplementary_files/lambdas/output_handlers/OPA"
            ),
            environment={
    ...
    def input_handler_cloudformation(self):
        ...
        self.lambda_invoked_by_apigw_cloudformation = aws_lambda.Function(
            ...
            memory_size=1024,
            code=aws_lambda.Code.from_asset(
                "./supplementary_files/lambdas/invoked_by_apigw_cloudformation"
            ),
            environment={
    ...
    def input_handler_config_event(self):
        ...
        self.lambda_invoked_by_apigw_config_event = aws_lambda.Function(
            ...
            memory_size=1024,
            code=aws_lambda.Code.from_asset(
                "./supplementary_files/lambdas/invoked_by_apigw_config_event"
            ),
            environment={
                "RawPaCResultsBucket": self.bucket_raw_pac_results.bucket_name,
                "OutputHandlers": json.dumps(
    ...
    def input_handler_cross_cloud_custom_auth(self):
        ...
        self.lambda_invoked_by_apigw_cross_cloud = aws_lambda.Function(
            ...
            memory_size=1024,
            code=aws_lambda.Code.from_asset(
                "./supplementary_files/lambdas/invoked_by_apigw_cross_cloud"
            ),
            environment={
                "RawPaCResultsBucket": self.bucket_raw_pac_results.bucket_name,
                "OutputHandlers": json.dumps(
    ...
    def input_handler_terraform(self):
        ...
        self.lambda_invoked_by_apigw_terraform = aws_lambda.Function(
            ...
            memory_size=1024,
            code=aws_lambda.Code.from_asset(
                "./supplementary_files/lambdas/invoked_by_apigw_terraform"
            ),
            environment={
                "RawPaCResultsBucket": self.bucket_raw_pac_results.bucket_name,
                "OutputHandlers": json.dumps(
    ...
    def input_handler_sam(self):
        ...
        self.lambda_invoked_by_apigw_sam = aws_lambda.Function(
            ...
            memory_size=1024,
            code=aws_lambda.Code.from_asset(
                "./supplementary_files/lambdas/invoked_by_apigw_sam"
            ),
            environment={
                "RawPaCResultsBucket": self.bucket_raw_pac_results.bucket_name,
                "OutputHandlers": json.dumps(
